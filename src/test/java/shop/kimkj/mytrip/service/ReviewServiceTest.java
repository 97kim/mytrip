...
//        // then
//        UserReview userReviewTest = userReviewRepository.findById(userReview.getId()).orElseThrow(
//                () -> new NullPointerException("Review 가 정상적으로 삭제되지 않았습니다.")
//        );
//        assertEquals("Review 가 정상적으로 삭제되었습니다.", Optional.empty(), userReviewTest);
//    }
//
//    @Test
//    @DisplayName("좋아요 성공")
...
//
//        // then
//        assertEquals("Review 가 정상적으로 삭제되었습니다.", userReviewLikesTest.getId(), userReview.getUserReviewLikes());
//    }
//}
//
